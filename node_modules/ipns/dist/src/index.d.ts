 ...
 */
export function create(privateKey: PrivateKey, value: Uint8Array, seq: number | bigint, lifetime: number): Promise<{
    value: Uint8Array;
 ...
 */
export function createWithExpiration(privateKey: PrivateKey, value: Uint8Array, seq: number | bigint, expiration: string): Promise<{
    value: Uint8Array;
    signature: Uint8Array;
    validityType: number;
    validity: Uint8Array;
